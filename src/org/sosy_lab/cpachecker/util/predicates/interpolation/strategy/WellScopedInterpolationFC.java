...
public class WellScopedInterpolationFC<T> extends AbstractTreeInterpolation<T> {
   ...
   */
  public WellScopedInterpolationFC(LogManager pLogger, ShutdownNotifier pShutdownNotifier,
