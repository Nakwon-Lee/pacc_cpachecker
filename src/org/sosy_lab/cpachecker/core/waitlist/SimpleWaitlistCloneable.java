 ...
 */
public class SimpleWaitlistCloneable extends AbstractWaitlistCloneable<Deque<AbstractState>> {

  private static final long serialVersionUID = 3467962481139001199L;
  private final TraversalMethod traversal;

  protected SimpleWaitlistCloneable(TraversalMethod pTraversal) {
