 ...
 */
public abstract class AbstractSortedWaitlistCloneable<K extends Comparable<K>> implements WaitlistCloneable {
   ...
   */
  protected AbstractSortedWaitlistCloneable(WaitlistFactory pSecondaryStrategy) {
