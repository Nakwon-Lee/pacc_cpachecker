 ...
 */
public class ExplicitSortedWaitlistCloneable extends AbstractSortedWaitlistCloneable<Integer> {

  private static final long serialVersionUID = -6101232093419788472L;

  protected ExplicitSortedWaitlistCloneable(WaitlistFactory pSecondaryStrategy) {
  ...
  public static WaitlistFactory factory(final WaitlistFactory pSecondaryStrategy) {
    return new WaitlistFactory() {
      ...
      public Waitlist createWaitlistInstance() {
        return new ExplicitSortedWaitlistCloneable(pSecondaryStrategy);
      }
    };
  }
}
