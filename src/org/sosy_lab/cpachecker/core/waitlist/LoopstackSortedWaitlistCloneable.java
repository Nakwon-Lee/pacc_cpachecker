 ...
 */
public class LoopstackSortedWaitlistCloneable extends AbstractSortedWaitlistCloneable<Integer>{

  private static final long serialVersionUID = 1115739856281327554L;

  public LoopstackSortedWaitlistCloneable(WaitlistFactory pSecondaryStrategy) {
  ...
  public static WaitlistFactory factory(final WaitlistFactory pSecondaryStrategy) {
    return new WaitlistFactory() {
      ...
      public Waitlist createWaitlistInstance() {
        return new LoopstackSortedWaitlistCloneable(pSecondaryStrategy);
      }
    };
  }
