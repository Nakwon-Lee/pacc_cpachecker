 ...
 */
public class CallstackSortedWaitlistCloneable extends AbstractSortedWaitlistCloneable<Integer> {

  private static final long serialVersionUID = 4292690381340976888L;

  protected CallstackSortedWaitlistCloneable(WaitlistFactory pSecondaryStrategy) {
  ...
  public static WaitlistFactory factory(final WaitlistFactory pSecondaryStrategy) {
    return new WaitlistFactory() {
      ...
      public Waitlist createWaitlistInstance() {
        return new CallstackSortedWaitlistCloneable(pSecondaryStrategy);
      }
    };
  }
}
