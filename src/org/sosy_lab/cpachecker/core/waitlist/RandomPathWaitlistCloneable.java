...
public class RandomPathWaitlistCloneable extends AbstractWaitlistCloneable<LinkedList<AbstractState>> {

  private static final long serialVersionUID = 6514705796663350230L;
  private final Random rand = new Random();
  private int successorsOfParent;
  private CFANode parent;

  protected RandomPathWaitlistCloneable() {
