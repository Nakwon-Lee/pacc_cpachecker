...
public class PostorderSortedWaitlistCloneable extends AbstractSortedWaitlistCloneable<Integer> {

  private static final long serialVersionUID = 3907147407498581546L;

  protected PostorderSortedWaitlistCloneable(WaitlistFactory pSecondaryStrategy) {
  ...
  public static WaitlistFactory factory(final WaitlistFactory pSecondaryStrategy) {
    return new WaitlistFactory() {
      ...
      public Waitlist createWaitlistInstance() {
        return new PostorderSortedWaitlistCloneable(pSecondaryStrategy);
      }
    };
  }
