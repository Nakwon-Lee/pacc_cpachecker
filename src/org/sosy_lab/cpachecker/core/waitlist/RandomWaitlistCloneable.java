...
public class RandomWaitlistCloneable extends AbstractWaitlistCloneable<LinkedList<AbstractState>> {

  private static final long serialVersionUID = 2236186825410114112L;
  private final Random rand = new Random();

  protected RandomWaitlistCloneable() {
