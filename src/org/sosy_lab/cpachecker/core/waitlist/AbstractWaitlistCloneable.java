 ...
 */
public abstract class AbstractWaitlistCloneable<T extends Collection<AbstractState>> implements WaitlistCloneable {

  private static final long serialVersionUID = -4221479882607044701L;
  protected final T waitlist;

  protected AbstractWaitlistCloneable(T pWaitlist) {
    waitlist = pWaitlist;
  }
