...
public interface SnappableAlgorithm extends Algorithm{
   ...
   */
  AlgorithmStatus run(ReachedSetList reachedSetList) throws CPAException, InterruptedException, CPAEnabledAnalysisPropertyViolationException;

  /**
   * This class serves as an indication how a result produced by an {@link SnappableAlgorithm}
