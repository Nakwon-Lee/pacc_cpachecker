...
public class BATSDEndSearchStrategyFormula implements SearchStrategyFormula {

  public BATSDEndSearchStrategyFormula() {
    super();
  }
 ...
 if(e1.CS() < e2.CS()){
  ...
  public static class Factory implements SearchStrategyFormula.Factory{
    ...
    public SearchStrategyFormula create() {
      return new BATSDEndSearchStrategyFormula();
    }
  }
}
