 ...
 * as the key.
 *
 * Whenever the method {@link PartitionedReachedSetCloneable#getReached(AbstractState)}
 ...
 */
public class PartitionedReachedSetCloneable extends DefaultReachedSetCloneable {

  private static final long serialVersionUID = -1268822569901977674L;
  private final Multimap<Object, AbstractState> partitionedReached = LinkedHashMultimap.create(100, 1);

  public PartitionedReachedSetCloneable(WaitlistFactory waitlistFactory) {
