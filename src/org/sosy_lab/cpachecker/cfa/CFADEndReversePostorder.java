...
import org.sosy_lab.cpachecker.cfa.model.DEndComparator;
import org.sosy_lab.cpachecker.util.CFAUtils;

public class CFADEndReversePostorder {
  ...
  public void assignSorting(final CFANode start) {
    ...
    while (!nodeStack.isEmpty()) {
      ...
      if (successors == null) {
        ...
        // enter the for loop
        PriorityQueue<CFANode> sortedset = new PriorityQueue<>(new DEndComparator());
